...
function fetchAnimals(e) {
  ...
  (0, _fetchJsonp.default)("http://api.petfinder.com/v2/animals?key=dqPCbHu221QesbRXdcm7mXQNESEbmtQhKogSa5GhtC3AGW1iNQ&type=".concat(animal, "&location=").concat(zip, "&callback=callback")).then(function (res) {
    return res.json;
  }).then(function (data) {
    return console.log(data);
  });
}
},{"fetch-jsonp":"node_modules/fetch-jsonp/build/fetch-jsonp.js"}],"C:/Users/User/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
